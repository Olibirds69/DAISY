...
class OverlayView(context: Context?, attrs: AttributeSet?) :
    ...
    fun setPoseResults(poseLandmarks: List<PoseLandmark>, imageHeight: Int, imageWidth: Int) {
    ...
    override fun draw(canvas: Canvas) {
        ...
        // Draw pose landmarks
        poseResults?.forEach { poseLandmark ->
            // Example for drawing pose landmarks, adjust as needed
            canvas.drawPoint(
                poseLandmark.position.x * imageWidth * scaleFactor,
                poseLandmark.position.y * imageHeight * scaleFactor,
                pointPaint
            )
        }
    }
    ...
    companion object {
        ...
        private const val LANDMARK_STROKE_WIDTH = 1F
    }
}
